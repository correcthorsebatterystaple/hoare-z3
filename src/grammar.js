...
var grammar = {
    ...
    {"name": "rel_exp$subexpression$2", "symbols": [(lexer.has("array_id") ? {type: "array_id"} : array_id)]},
    {"name": "rel_exp$subexpression$2", "symbols": [(lexer.has("array_id_aux") ? {type: "array_id_aux"} : array_id_aux)]},
    {"name": "rel_exp$ebnf$1", "symbols": ["store_term"], "postprocess": id},
    {"name": "rel_exp$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "rel_exp$subexpression$3", "symbols": ["_", {"literal":"="}, "_"]},
    {"name": "rel_exp$subexpression$4", "symbols": [(lexer.has("array_id") ? {type: "array_id"} : array_id)]},
    {"name": "rel_exp$subexpression$4", "symbols": [(lexer.has("array_id_aux") ? {type: "array_id_aux"} : array_id_aux)]},
    {"name": "rel_exp$ebnf$2", "symbols": ["store_term"], "postprocess": id},
    {"name": "rel_exp$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "rel_exp", "symbols": ["rel_exp$subexpression$2", "rel_exp$ebnf$1", "rel_exp$subexpression$3", "rel_exp$subexpression$4", "rel_exp$ebnf$2"], "postprocess": d => ({type: 'rel_exp', value: d[2][1], left: d[0][0], right: d[3][0]})},
    ...
    {"name": "array_term$subexpression$1", "symbols": [(lexer.has("array_id") ? {type: "array_id"} : array_id)]},
    ...
    {"name": "array_term", "symbols": ["array_term$subexpression$1", "array_term$subexpression$2", "mod_term", "array_term$subexpression$3"], "postprocess": d => ({type: 'array', value: d[0][0], arg: d[2]})},
    {"name": "array_term$subexpression$4", "symbols": [(lexer.has("array_id") ? {type: "array_id"} : array_id)]},
    {"name": "array_term$subexpression$4", "symbols": [(lexer.has("return_id") ? {type: "return_id"} : return_id)]},
    {"name": "array_term$subexpression$5", "symbols": ["_", (lexer.has("left_array_bracket") ? {type: "left_array_bracket"} : left_array_bracket), "_"]},
    {"name": "array_term$subexpression$6", "symbols": ["_", (lexer.has("right_array_bracket") ? {type: "right_array_bracket"} : right_array_bracket)]},
    {"name": "array_term", "symbols": ["array_term$subexpression$4", "store_term", "array_term$subexpression$5", "mod_term", "array_term$subexpression$6"], "postprocess": d => ({type: 'array', value: d[0][0], arg: d[3], replace: d[1]})},
    {"name": "store_term$subexpression$1", "symbols": ["_", {"literal":"{"}, "_"]},
    {"name": "store_term$subexpression$2", "symbols": ["_", (lexer.has("replace_op") ? {type: "replace_op"} : replace_op), "_"]},
    {"name": "store_term$subexpression$3", "symbols": ["_", {"literal":"}"}, "_"]},
    {"name": "store_term", "symbols": ["store_term", "store_term$subexpression$1", "mod_term", "store_term$subexpression$2", "mod_term", "store_term$subexpression$3"], "postprocess": d => [...d[0], [d[2],d[4]]]},
    {"name": "store_term$subexpression$4", "symbols": ["_", {"literal":"{"}, "_"]},
    {"name": "store_term$subexpression$5", "symbols": ["_", (lexer.has("replace_op") ? {type: "replace_op"} : replace_op), "_"]},
    {"name": "store_term$subexpression$6", "symbols": ["_", {"literal":"}"}, "_"]},
    {"name": "store_term", "symbols": ["store_term$subexpression$4", "mod_term", "store_term$subexpression$5", "mod_term", "store_term$subexpression$6"], "postprocess": d => [[d[1],d[3]]]},
