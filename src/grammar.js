...
var grammar = {
    ...
    {"name": "math_exp", "symbols": ["mod_term"], "postprocess": id},
    {"name": "mod_term$subexpression$1", "symbols": ["_", (lexer.has("mod_op") ? {type: "mod_op"} : mod_op), "_"]},
    {"name": "mod_term", "symbols": ["mod_term", "mod_term$subexpression$1", "sum_term"], "postprocess": d => ({type: 'math_op', value: d[1][1], left: d[0], right: d[2]})},
    {"name": "mod_term", "symbols": ["sum_term"], "postprocess": id},
    ...
    {"name": "mul_term", "symbols": [{"literal":"("}, "mod_term", {"literal":")"}], "postprocess": d => d[1]},
    ...
    {"name": "arg_list", "symbols": ["arg_list", "arg_list$subexpression$1", "mod_term"], "postprocess": d => [...d[0], d[2]]},
    {"name": "arg_list", "symbols": ["mod_term"]},
    ...
    {"name": "term$subexpression$1", "symbols": ["array_term"]},
    {"name": "term", "symbols": ["term$subexpression$1"], "postprocess": d => d[0][0]},
    {"name": "array_term$subexpression$1", "symbols": [(lexer.has("id") ? {type: "id"} : id)]},
    {"name": "array_term$subexpression$1", "symbols": [(lexer.has("return_id") ? {type: "return_id"} : return_id)]},
    {"name": "array_term$subexpression$2", "symbols": ["_", (lexer.has("left_array_bracket") ? {type: "left_array_bracket"} : left_array_bracket), "_"]},
    {"name": "array_term$subexpression$3", "symbols": ["_", (lexer.has("right_array_bracket") ? {type: "right_array_bracket"} : right_array_bracket)]},
    {"name": "array_term", "symbols": ["array_term$subexpression$1", "array_term$subexpression$2", "term", "array_term$subexpression$3"], "postprocess": d => ({type: 'array', value: d[0][0], arg: d[2]})},
